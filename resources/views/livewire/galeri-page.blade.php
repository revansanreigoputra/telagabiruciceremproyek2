<div class="max-w-full">
  <div class="flex justify-center space-x-8 mt-4 overflow-x-auto whitespace-nowrap w-full">
    ...
    <a href="#" class="text-gray-500 hover:text-gray-700">Perahu</a>
    <a href="#" class="text-gray-500 hover:text-gray-700">Perahu Layar</a>
    <a href="#" class="text-gray-500 hover:text-gray-700">Perahu Jembatan</a>
  </div>
          ...
          <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
              <div class="group relative">
                  <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                      <img src="{{ asset('img/2.jpg') }}" alt="Front of men&#039;s Basic Tee in black." class="h-full w-full object-cover object-center lg:h-full lg:w-full">
                  </div>
                  <div class="mt-4 flex justify-between">
                      <div>
                          ...
                          <p class="mt-1 text-sm text-gray-500"> <span class="text-gray-700">Src :</span> Cinematic Traveling</p>
                      </div>
                  </div>
              </div>
